...
export default function Post({post}) {
  return (
    <div className="flex p-3 border-b border-gray-200 space-x-3">
      {/* user image */}
      <div className="">
        <Image 
      ...
      <div className="flex-1">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="inline-flex items-center space-x-1 whitespace-nowrap">
            <h4 className="flex-1 font-bold text-[15px] sm:text-[16px] hover:underline cursor-pointer">{post.data().name}</h4>
